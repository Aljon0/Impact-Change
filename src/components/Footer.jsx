        ...
        <div className="flex justify-between items-start mb-8">
          ...
          <div className="flex-1 max-w-2xl flex justify-end">
            <div className="w-full max-w-md">
              <h3 className="text-xl font-bold text-blue-600 mb-6">Services</h3>
              <div className="grid grid-cols-2 gap-x-8 gap-y-2">
                <div className="space-y-2">
                  <div className="text-[#4a4949] text-sm">
                  ...
                  <div className="text-[#4a4949] text-sm">Market Research</div>
                  <div className="text-[#4a4949] text-sm">
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-[#4a4949] text-sm">Career Coaching</div>
                  <div className="text-[#4a4949] text-sm">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex space-x-3">
            <a
              ...
              onMouseEnter={(e) => (e.target.style.backgroundColor = "#001a68")}
              onMouseLeave={(e) => (e.target.style.backgroundColor = "#011e76")}
            >
              <svg
