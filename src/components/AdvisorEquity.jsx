  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4">
                <button className="group bg-white text-blue-700 px-8 py-4 rounded-full font-semibold text-lg hover:bg-blue-50 transition-all duration-300 flex items-center justify-center transform hover:scale-105">
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 border border-white/20">
                <div className="grid grid-cols-2 gap-6">
                  <div className="text-center">
                    ...
                    <div className="text-2xl font-bold text-white">0.25-1%</div>
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-blue-200">Vesting</div>
                  </div>
                  <div className="text-center">
                    <Users className="h-12 w-12 text-indigo-300 mx-auto mb-3" />
                    <div className="text-2xl font-bold text-white">Select</div>
                    <div className="text-blue-200">Founders</div>
                  </div>
                  <div className="text-center">
                    ...
                    <div className="text-blue-200">Always</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-3xl p-8 text-white relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <TrendingUp className="h-16 w-16 text-cyan-300 mb-6" />
        ...
        {/* Next Steps Section */}
        <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-3xl p-12 lg:p-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <button className="group bg-gradient-to-r from-blue-600 to-indigo-700 text-white px-10 py-5 rounded-full font-semibold text-lg hover:shadow-lg transition-all duration-300 flex items-center justify-center transform hover:scale-105">
                Let's talk about equity
                <ArrowRight className="ml-3 h-6 w-6 group-hover:translate-x-1 transition-transform" />
              </button>
              <button className="border-2 border-blue-600 text-blue-600 px-10 py-5 rounded-full font-semibold text-lg hover:bg-blue-600 hover:text-white transition-all duration-300">
                View Core Services
              </button>
            </div>
          </div>
